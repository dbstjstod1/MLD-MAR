...
from quantise import DiagonalGaussianDistribution
...
class Model(nn.Module):
    def __init__(self, input_dim, num_hiddens, num_residual_layers, num_residual_hiddens, 
        ...
        self._vq_vae = DiagonalGaussianDistribution()
    ...
    def encode(self, x):
        ...
        quantized, emb_loss = self._vq_vae(z_e_x)
